...
OUTPUT_COLUMNS = [
    ...
    "dose_recognized","dose_kind_detected","route","route_source","route_text","form","form_source","form_text",
    ...
    "who_molecules","who_atc_codes","who_atc_count","who_atc_has_ddd","who_atc_adm_r",
