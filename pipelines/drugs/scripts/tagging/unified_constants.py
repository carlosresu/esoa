...
STOPWORDS: Set[str] = {
    ...
    # Descriptors (added from unknown analysis)
    "ACETATED", "ADULT", "ALFA", "AMINO", "ANTISEPTIC", "AQUEOUS",
    "ATTENUATED", "BALANCED", "BASED", "BENZYL", "BETA", "BIPHASIC",
    "BLUE", "CARE", "CARPULE", "CASTOR", "CELL", "CHEWABLE", "CHICK",
    "CLEANSER", "COATED", "COMBI", "COMPLEX", "CONCENTRATE", "COUNT",
    "DEGRADED", "DERIVATIVE", "DEXTROSE", "DIABETES", "DIALYSATE",
    "DIALYSIS", "DIBASIC", "DOSE", "DOSES", "DRUGS", "DURULES",
    "EFFERVESCENT", "EMBRYO", "EQUINE", "ETHYL", "FEVER", "FLUID",
    "FOLIC", "FREE", "GALLON", "HEMODIALYSIS", "HEPATIC", "HEPATITIS",
    "HIGH", "HUMAN", "HYDROGEN", "HYDROXYETHYL", "HYPERTONIC",
    "IMMUNOGLOBULIN", "INACTIVATED", "INFANTS", "ISOPHANE", "JELLY",
    "JUNIOR", "KCAL", "LACTATED", "LIPID", "LIQUID", "LIVE",
    ...
    "PEDIA", "PEDIATRIC", "PEROXIDE", "PETROLEUM", "PLAIN", "POUCH",
    "PROTEIN", "PURIFIED", "RABIES", "RECOMBINANT", "REGULAR",
    "REHYDRATION", "RELEASE", "RENAL", "REPLACEMENT", "RESPIRATORY",
    "RETINOL", "ROSE", "SALINE", "SALT", "SALTS", "SERUM", "SINGLE",
    "SKIN", "SOFT", "SOLVENT", "SPINAL", "STANDARD", "STARCH", "STERILE",
    "SURGICAL", "TOXOID", "TUBERCULIN", "VACCINE", "VERO", "WITHOUT",
    "YELLOW", "ALCOHOL",
}
...
SALT_TOKENS: Set[str] = {
    ...
    "PHOSPHATE", "HYDROXIDE", "DIPROPIONATE", "ACETATE", "TARTRATE",
    "FUMARATE", "OXALATE", "MALEATE", "MESYLATE", "TOSYLATE", "BESYLATE",
    "BESILATE", "BITARTRATE", "SUCCINATE", "CITRATE", "LACTATE",
    "GLUCONATE", "BICARBONATE", "CARBONATE", "BROMIDE", "CHLORIDE",
    "IODIDE", "SELENITE", "THIOSULFATE", "FLUORIDE",
    
    # Ester salts
    "DECANOATE", "PALMITATE", "STEARATE", "PAMOATE", "BENZOATE",
    "VALERATE", "PROPIONATE", "HYDROBROMIDE", "DOCUSATE", "HEMISUCCINATE",
    "FUROATE", "FUSIDATE", "SALICYLATE", "FOLINATE", "ASCORBATE",
    
    # Complex salts (added from unknown analysis)
    "ACETONIDE", "AXETIL", "BENZATHINE", "CLAVULANATE", "DIHYDROCHLORIDE",
    "DINITRATE", "DISODIUM", "GLYCERYL", "MESILATE", "PENTAHYDRATE",
    "POLYMERISATE", "SUCCINYLATED", "SULFONATE", "TRINITRATE", "TROMETHAMOL",
...
PURE_SALT_COMPOUNDS: Set[str] = {
    ...
    "FERROUS SULPHATE", "ZINC SULFATE", "ZINC SULPHATE",
